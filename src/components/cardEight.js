...
const CardEight = function CardEight(props) {
  ...
  return (
    <div class={`card--` + suitColor}>
      ...
      <span class="card__pip card__pip--middle_left">{suitSymbol}</span>
      <span class="card__pip card__pip--middle_right">{suitSymbol}</span>
      <span class="card__pip card__pip--middle_top">{suitSymbol}</span>
      <span class="card__pip card__pip--middle_bottom">{suitSymbol}</span>
