...
const CardTen = function CardTen(props) {
  ...
  return (
    <div class={`card--` + suitColor}>
      ...
      <span class="card__pip card__pip--middle_top_left">{suitSymbol}</span>
      <span class="card__pip card__pip--middle_top_center">{suitSymbol}</span>
      <span class="card__pip card__pip--middle_top_right">{suitSymbol}</span>
      <span class="card__pip card__pip--bottom_left">{suitSymbol}</span>
      <span class="card__pip card__pip--bottom_right">{suitSymbol}</span>
      <span class="card__pip card__pip--middle_bottom_center">{suitSymbol}</span>
      <span class="card__pip card__pip--middle_bottom_left">{suitSymbol}</span>
      <span class="card__pip card__pip--middle_bottom_right">{suitSymbol}</span>
